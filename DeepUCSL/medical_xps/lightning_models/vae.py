...
from DeepUCSL.medical_xps.architectures.vae import VAE

# TODO: write the configs:
#  Importantly, VAE's for 2D medical datasets take images that are 64x64 pixels as inputs

class LitVAE(LightningModule):
    def __init__(self, model_type, loss, loss_params, lr, fold):
        super().__init__()
