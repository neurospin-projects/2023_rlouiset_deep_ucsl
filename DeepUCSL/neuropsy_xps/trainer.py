...
from DeepUCSL.neuropsy_xps.pl_models_getter import *
from DeepUCSL.neuropsy_xps.pl_callbacks_getter import *
    ...
    def run(self):
        ...
        for fold in folds:
            ...
            trainer = pl.Trainer(min_epochs=self.args["min_epochs"], max_epochs=self.args["max_epochs"],
                                 gpus=self.args["gpus"], logger=tb_logger, enable_checkpointing=False,
